...
## Introduction
This repository has taken definitions outlined in [Python Glossary](https://docs.python.org/3/glossary.html) and put them into a form which can be easily learnt/revised using <a href="https://apps.ankiweb.net/">Anki</a> a cross platform app specifically designed for long term knowledge retention.

## Notes
Please note the modifications which have been made & where you can find updates.
1. The front of every card has "(Python Glossary)" appended to the end so that if you have any other words in your collection, the Python Glossary definition will still be added when importing it.
...
4. Any updates, translations or corrections to the deck will be available at <a href="https://github.com/darigovresearch/Python-Glossary-Flashcards">https://github.com/darigovresearch/Python-Glossary-Flashcards</a> so do return periodically to check if you have the latest version.
